...
options:
  ...
  netmask_bits:
    description:
      ...
      - "Is required to add the SapHana hosts to the cluster's global whitelists."
    type: int
  platform:
    choices:
      - Linux
...
def update_global_whitelists(module):
    """"
    Function to update the cluster global whitelists.
...
def main():
    ...
    if module.check_mode:
        ...
        # Endpoint should be added to global whitelists for SapHana platform.
        if module.params.get("platform") == "SapHana":
            update_global_whitelists(module)
